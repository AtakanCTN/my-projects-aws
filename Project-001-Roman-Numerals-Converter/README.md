...
```bash
aws ec2 describe-security-groups --group-names roman_numbers_sec_grp    // sg-0edd34fb9c1c9edc5
```
...
pip3 install flask
cd /home/ec2-user
FOLDER="https://raw.githubusercontent.com/okti3535/my-projects/main/Project-001-Roman-Numerals-Converter/"
wget ${FOLDER}/app.py
